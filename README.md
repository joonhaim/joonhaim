...
### 🔍 Interests
- Biomedical Engineering · Surgical Visualization · AR/VR in Surgery · AI in Medical Imaging  

### 🚀 Featured Projects
- **[EduPace](https://github.com/joonhaim/edupace)** - TU Delft Minor Project - External Pacemaker Simulator
- **[Swiss Hospital Insights](https://joonhaim.github.io/ch_hospital.html)** - Interactive dashboard on hospital case volumes across Switzerland
